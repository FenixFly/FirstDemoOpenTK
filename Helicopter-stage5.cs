...
namespace Helicopter
{
    ...
    public partial class Form1 : Form
    {
        ...
        private void glControl1_Load(object sender, EventArgs e)
        {
            ...
            //textures[2] = loadTexture("heightmap.png");
            Random R = new Random();
            ...
            map = new Bitmap(AppDomain.CurrentDomain.BaseDirectory + "..\\..\\heightmap.png");
        ...
        private void Render()
        {
            ...
            //DrawGrid(Color.Blue, 0, 0, -1, 1, 256);
        ...
        {
            if (value < 50)
                return Color.FromArgb(50 + value, 50 + value, 90 + value * 2);
            else if (value <100)
